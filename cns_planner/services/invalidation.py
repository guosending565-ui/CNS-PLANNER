...
DEPENDENTS = {
    "data": ("workspace", "environment_risk", "routes", "coverage", "cns_gap", "coverage_3d", "cns_service_capability", "report"),
    "workspace": ("environment_risk", "routes", "coverage", "cns_gap", "coverage_3d", "cns_service_capability", "report"),
    "route": ("coverage", "cns_gap", "coverage_3d", "cns_service_capability", "report"),
    "rules": ("routes", "coverage", "cns_gap", "coverage_3d", "cns_service_capability", "technical_risk", "report"),
    "aircraft_profile": ("routes", "coverage", "cns_gap", "cns_service_capability", "technical_risk", "report"),
    "required_cns": ("coverage", "cns_gap", "cns_service_capability", "report"),
    "devices": ("coverage", "cns_gap", "coverage_3d", "cns_service_capability", "technical_risk", "report"),
    "existing_cns": ("coverage", "cns_gap", "coverage_3d", "cns_service_capability", "technical_risk", "report"),
    "candidate_sites": ("coverage", "technical_risk", "report"),
    "sites": ("coverage", "technical_risk", "report"),
    "route_algorithm": ("routes", "coverage", "cns_gap", "coverage_3d", "cns_service_capability", "report"),
