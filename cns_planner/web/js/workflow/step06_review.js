...
export function render({state,flow}){
  ...
  const resultLabels={workspace:'工作区',grid:'标准网格',environment_risk:'环境风险',routes:'运行航路',coverage:'C/N/S 布站',cns_corridor_assessment:'CNS 服务需求走廊',technical_risk:'技术风险',report:'报告'};
