...
class ProjectState(TypedDict, total=False):
    ...
    encounter_3d_assessment: dict[str, Any]
    ...
    cns_planning_objectives: dict[str, Any]
    cns_corridor_gap_assessment: dict[str, Any]
    corridor_site_planning_policy: dict[str, Any]
