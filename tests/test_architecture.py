...
def test_registry_declares_present_and_future_source_categories():
    ...
    assert {"basemap", "airspace", "population", "terrain", "buildings", "property_exposure", "obstacles", "infrastructure", "towers", "traffic", "existing_cns", "candidate_sites"} <= source_ids
